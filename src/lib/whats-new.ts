...
export const WHATS_NEW: Record<string, string[]> = {
  ...
  "1.9.26": [
    "发消息偶尔转圈很久，后台加上了分段计时，下次再卡能直接定位是哪一段慢",
  ],
  "1.9.25": [
    "每次发消息后面跟的一长串启动提示，收成一行“启动过程”了，点开展开还是完整过程；有警告会挂个标",
    "群里发的视频机器人能收了：小视频给封面加原文件，几个 G 的大视频给封面加几帧画面加一句话交代，不再回“暂不支持”",
  ],
  "1.9.24": [
    "修复应用更新后启动时闪退报错的问题",
  ],
  "1.9.23": [
    "长任务防崩的底层准备已就绪，默认关闭不影响现有行为",
  ],
  "1.9.22": [
